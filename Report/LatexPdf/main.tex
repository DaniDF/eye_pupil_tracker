...
\centering
\includegraphics[scale=0.13]{img/CameraApp_Screen_nerd_layout.jpg}
\end{figure}
...
\centering
\includegraphics[scale=0.15]{img/CameraApp_Screen_nerd.jpg}
\end{figure}
...
\centering
\includegraphics[scale=0.16]{img/CameraApp_Screen_calibration.jpg}
\end{figure}
...
\begin{figure}[h]
	...
	\includegraphics[scale=0.14]{img/CameraApp_Screen_quiz.jpg}
\end{figure}
