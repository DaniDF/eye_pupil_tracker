        ...
        findViewById<FloatingActionButton>(R.id.pupil_detector_button).apply {
            setOnClickListener {
                when(this@EyeTrackingActivity.toggleFindPupils()) {
                    true -> setImageResource(R.drawable.ic_pupil_off)
                    false -> setImageResource(R.drawable.ic_pupil_on)
                }
            }
        }
        ...
        eyes.forEachIndexed { index, obj ->
            ...
            if(index < 5) {
                ...
                if(!this::pupilTrackingDetector.isInitialized) {
                    this.pupilTrackingDetector = PupilTrackingDetector(this).apply {
